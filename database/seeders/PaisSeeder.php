...
class PaisSeeder extends Seeder
{
    ...
    public function run()
    {
        $json = json_decode('{"paises": [
            ...
            {"id":660,"alpha2":"ai","alpha3":"aia","name":"Anguila"},
            {"id":10,"alpha2":"aq","alpha3":"ata","name":"Antártida"},
            ...
            {"id":60,"alpha2":"bm","alpha3":"bmu","name":"Bermudas"},
            {"id":112,"alpha2":"by","alpha3":"blr","name":"Bielorrusia"},
            {"id":68,"alpha2":"bo","alpha3":"bol","name":"Bolivia"},
            {"id":535,"alpha2":"bq","alpha3":"bes","name":"Bonaire, San Eustaquio y Saba"},
            ...
            {"id":531,"alpha2":"cw","alpha3":"cuw","name":"Curazao"},
            ...
            {"id":312,"alpha2":"gp","alpha3":"glp","name":"Guadalupe"},
            {"id":316,"alpha2":"gu","alpha3":"gum","name":"Guam"},
            {"id":320,"alpha2":"gt","alpha3":"gtm","name":"Guatemala"},
            {"id":254,"alpha2":"gf","alpha3":"guf","name":"Guayana Francesa"},
            ...
            {"id":74,"alpha2":"bv","alpha3":"bvt","name":"Isla Bouvet"},
            {"id":833,"alpha2":"im","alpha3":"imn","name":"Isla de Man"},
            {"id":162,"alpha2":"cx","alpha3":"cxr","name":"Isla de Navidad"},
            {"id":352,"alpha2":"is","alpha3":"isl","name":"Islandia"},
            {"id":136,"alpha2":"ky","alpha3":"cym","name":"Islas Caimán"},
            {"id":166,"alpha2":"cc","alpha3":"cck","name":"Islas Cocos"},
            {"id":184,"alpha2":"ck","alpha3":"cok","name":"Islas Cook"},
            {"id":234,"alpha2":"fo","alpha3":"fro","name":"Islas Feroe"},
            {"id":239,"alpha2":"gs","alpha3":"sgs","name":"Islas Georgias del Sur y Sandwich del Sur"},
            {"id":334,"alpha2":"hm","alpha3":"hmd","name":"Islas Heard y McDonald"},
            {"id":238,"alpha2":"fk","alpha3":"flk","name":"Islas Malvinas"},
            {"id":580,"alpha2":"mp","alpha3":"mnp","name":"Islas Marianas del Norte"},
            {"id":584,"alpha2":"mh","alpha3":"mhl","name":"Islas Marshall"},
            {"id":612,"alpha2":"pn","alpha3":"pcn","name":"Islas Pitcairn"},
            {"id":90,"alpha2":"sb","alpha3":"slb","name":"Islas Salomón"},
            {"id":796,"alpha2":"tc","alpha3":"tca","name":"Islas Turcas y Caicos"},
            {"id":581,"alpha2":"um","alpha3":"umi","name":"Islas Ultramarinas Menores de los Estados Unidos"},
            {"id":92,"alpha2":"vg","alpha3":"vgb","name":"Islas Vírgenes Británicas"},
            {"id":850,"alpha2":"vi","alpha3":"vir","name":"Islas Vírgenes de los Estados Unidos"},
            ...
            {"id":574,"alpha2":"nf","alpha3":"nfk","name":"Isla Norfolk"},
            {"id":578,"alpha2":"no","alpha3":"nor","name":"Noruega"},
            {"id":540,"alpha2":"nc","alpha3":"ncl","name":"Nueva Caledonia"},
            ...
            {"id":732,"alpha2":"eh","alpha3":"esh","name":"República Árabe Saharaui Democrática"},
            ...
            {"id":638,"alpha2":"re","alpha3":"reu","name":"Reunión"},
            ...
            {"id":16,"alpha2":"as","alpha3":"asm","name":"Samoa Americana"},
            {"id":652,"alpha2":"bl","alpha3":"blm","name":"San Bartolomé"},
            {"id":659,"alpha2":"kn","alpha3":"kna","name":"San Cristóbal y Nieves"},
            {"id":674,"alpha2":"sm","alpha3":"smr","name":"San Marino"},
            {"id":663,"alpha2":"mf","alpha3":"maf","name":"San Martín"},
            {"id":666,"alpha2":"pm","alpha3":"spm","name":"San Pedro y Miquelón"},
            {"id":670,"alpha2":"vc","alpha3":"vct","name":"San Vicente y las Granadinas"},
            {"id":654,"alpha2":"sh","alpha3":"shn","name":"Santa Elena, Ascensión y Tristán de Acuña"},
            ...
            {"id":534,"alpha2":"sx","alpha3":"sxm","name":"San Martín"},
            ...
            {"id":744,"alpha2":"sj","alpha3":"sjm","name":"Svalbard y Jan Mayen"},
            {"id":764,"alpha2":"th","alpha3":"tha","name":"Tailandia"},
            {"id":158,"alpha2":"tw","alpha3":"twn","name":"Taiwán (República de China)"},
            {"id":834,"alpha2":"tz","alpha3":"tza","name":"Tanzania"},
            {"id":762,"alpha2":"tj","alpha3":"tjk","name":"Tayikistán"},
            {"id":86,"alpha2":"io","alpha3":"iot","name":"Territorio Británico del Océano Índico"},
            {"id":260,"alpha2":"tf","alpha3":"atf","name":"Tierras Australes y Antárticas Francesas"},
            ...
            {"id":336,"alpha2":"va","alpha3":"vat","name":"Vaticano, Ciudad del"},
            {"id":862,"alpha2":"ve","alpha3":"ven","name":"Venezuela"},
            {"id":704,"alpha2":"vn","alpha3":"vnm","name":"Vietnam"},
            {"id":876,"alpha2":"wf","alpha3":"wlf","name":"Wallis y Futuna"},
        ...
        foreach ($json->paises as $pais) {
            DB::table('paises')->insert([
                ...
                'iso2' => $pais->alpha2,
                'iso3' => $pais->alpha3,
                'codigo_tel' => $pais->name == 'México' ? '+52' : 0,
            ]);
        }
    }
}
